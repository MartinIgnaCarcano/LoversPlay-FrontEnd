...
export default function HomePage() {
  ...
  useEffect(() => {
    // Más vistos
    fetchProductos({ page: 1, per_page: 8, sort: "views" }).then((data) =>
      setPopularProducts(data.productos),
    );

    // Más nuevos
    fetchProductos({ page: 1, per_page: 8, sort: "newest" }).then((data) =>
        ...
        <section className="bg-white pb-4">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground font-[family-name:var(--font-inter)]">
                Nuestra selección de productos más recientes
              </p>
            </div>
        ...
        <section className="relative py-16 overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 text-center">
            ...
            <p className="max-w-3xl mx-auto mb-12 text-lg text-muted-foreground leading-relaxed">
              Somos una tienda de bienestar íntimo constituida{" "}
              <strong>Desde 1997</strong> en Mendoza, acompañando a personas y
              parejas a descubrir su sexualidad de forma
              <strong> segura, confiable y discreta</strong>. En Lovers Play
              combinamos <strong>atención personalizada</strong>, un{" "}
              <strong>catálogo variado</strong> y{" "}
              <strong>precios competitivos</strong>, para que cada compra sea
              una experiencia cómoda, respetuosa y sin prejuicios.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-card rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-200">
                ...
                <p className="text-muted-foreground font-[family-name:var(--font-inter)]">
                  Todos nuestros productos se envían en empaques completamente
                  discretos
                </p>
              </div>
              ...
              <div className="bg-card rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-200">
                ...
                <p className="text-muted-foreground font-[family-name:var(--font-inter)]">
                  Productos de las mejores marcas con materiales seguros y
                  certificados
                </p>
              </div>
              ...
              <div className="bg-card rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-200">
                ...
                <p className="text-muted-foreground font-[family-name:var(--font-inter)]">
                  Nuestro equipo te ayuda a encontrar el producto perfecto para
                  ti
                </p>
              </div>
            </div>
