        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[65vh]">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/60 cursor-pointer text-primary-foreground text-lg px-8 py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-[family-name:var(--font-work-sans)] font-semibold"
                asChild
              >
